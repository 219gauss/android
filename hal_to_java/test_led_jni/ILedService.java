...
@Override public void SetLed(int no, int val) throws android.os.RemoteException
{
...
_data.writeInt(no);
_data.writeInt(val);
mRemote.transact(Stub.TRANSACTION_SetLed, _data, _reply, 0);
...
public void SetLed(int no, int val) throws android.os.RemoteException;
}
